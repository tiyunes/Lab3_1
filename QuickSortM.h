...
template<typename T>
void QuickSortMH(Sequence<T>* s, function<bool(T, T)> cmp, int left, int right)
{
    int i, j;
    T pivot, buff;
    i = left;
...
template<typename T>
Sequence<T>* QuickSortM(Sequence<T>* s, function<bool(T, T)> cmp)
{
    int i, j, left, right;
    T pivot, buff;
